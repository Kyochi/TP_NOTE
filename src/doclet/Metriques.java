...
public class Metriques extends Doclet {
	...
	/**
	 * <p>
	 * La m√©thode start() est appel√©e automatiquement par l'outil
	...
	public static boolean start(RootDoc root) { 
		...
		System.out.println("Le nombre de classe concrËte publique est de " + nombreDeClassesPublique + ".");
		System.out.println("\t" + "- Le nombre moyen de mÈthode par classe concrËte publique est de " + nombreMoyenDeMethodeParClassePublique +  ".");
		System.out.println("\t" + "- Le nombre moyen de commentaire javadoc par membre de classe concrËte publique est de " + nombreMoyenDeCommentaireParMembreDeClassePublique + ".");
		
		System.out.println("Le nombre de classe concrËte privÈe est de " + nombreDeClassesPrivee + ".");
